...
/*---------------------------------------------------------------------------*/
//	used in the future
struct env_struct_t { //co tong cong 15 bytes
...
struct net_struct_t { //co tong cong 24 bytes 
	uint8_t			channel;	
	int8_t			rssi;
	int8_t			lqi;
	int8_t			tx_power;
...
//	arg[16]: data payload
struct cmd_struct_t { //cmd_struct_t có tong cong 9 bytes
	uint8_t  	sfd;
	uint8_t 	len;
	uint16_t 	seq;
	uint8_t		type;
